...
const English2018 = appData.spring2018.English
const network2018 = appData.spring2018.network
...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  devServer: {
    before(app){
      ...
      app.get('/api/English2018',(req,res) => {
        res.json({
          errno: 0,
          data: English2018
        })
      })
      app.get('/api/network2018',(req,res) => {
        res.json({
          errno: 0,
          data: network2018
        })
